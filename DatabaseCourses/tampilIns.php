            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse bg-primary">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="tampilIns.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <div class="header-card">
                        <h2><i class="fas fa-chalkboard-teacher me-2"></i>Daftar Instruktur</h2>
                    </div>
                </div>

                <div class="table-container">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="tambahIns.php" class="btn btn-add">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <a href="editIns.php?id=<?php echo $data['instructor_id'] ?>" class="btn-edit">
