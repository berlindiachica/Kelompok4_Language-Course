...
<head>
    ...
    <title>Update Data Instructor</title>
    <!-- Bootstrap CSS -->
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <div class="header-card">
                        <h2><i class="fas fa-user-plus me-2"></i>Update Data Instructor</h2>
                    </div>
                </div>
                ...
                <div class="form-container">
                    <form action="" method="post">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="instructor_id" name="instructor_id" value="<?php echo $data['instructor_id'] ?>" required>
                        </div>
                        <div class="mb-4">
                            <label for="instructor_name" class="form-label">Nama</label>
                            <input type="text" class="form-control" id="instructor_name" name="instructor_name" value="<?php echo $data['instructor_name'] ?>" required>
                        </div>
                        <div class="mb-4">
                            <label for="expertise" class="form-label">Keahlian</label>
                            <input type="text" class="form-control" id="expertise" name="expertise" value="<?php echo $data['expertise'] ?>" required>
                        </div>
                        <div class="mb-4">
